...
import { ClientWiseReportModal } from "../../ClientWise/Components/ClientWiseReportModel";
...
const breadCrumbs = [
  ...
  // },
  {
    pageName: "Team Leader Wise",
    pageURL: "/team-leader-wise",
  },
];
  ...
  return (
    <div className={`main-content ${sidebarClose ? "sidebarClose" : ""}`}>
      ...
      {isLoading ? (
        ...
        <div className="team-leader-wise-table">
          <ReportsTable
            tableInstance={tableInstance}
            headers={headers}
            reportsData={clientsReportData}
          />
        </div>
      ) : (
        <div className="mr-40 ml-30 mb-15">
...
export default TeamLeaderWiseContent;
